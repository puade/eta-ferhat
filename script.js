  ...
  if (recipientName) {
    const newUrl = `https://puade.github.io/eta-ferhat/?kepada=${recipientName}`;
    ...
    // Countdown function
    function countdown() {
      const countDate = new Date("May 1, 2026 15:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const frameLoveStory = document.getElementById('frame-lovestory'); // <-- tambah ini
  ...
  openMusicBtn.addEventListener('click', () => {
    ...
    frameLoveStory.style.display = 'flex'; // <-- tambah ini
...
function fetchUcapan() {
  var url = 'https://script.google.com/macros/s/AKfycbytpCxBhhFt-MU4hT7XMEMP-4uvLOqAdummTdLz1Pp4gFhIGYbIkyYKSD36-1N5fZtK/exec'; // Ganti dengan URL Web App Google Apps Script Anda
